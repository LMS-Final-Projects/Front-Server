        ...
        <>
            <div className='list-group list-group-flush'>
                ...
                <div className="collapse" id="applicationMenu">
                    <Link to="/professor/accept" className='list-group-item py-2'>수강 승인</Link>
                </div>
                ...
                <div className="collapse" id="gradeMenu">
                    <Link to="/professor/grade/set" className='list-group-item py-2'>성적 입력</Link>
                    <Link to="/professor/grade/update" className='list-group-item py-2'>성적 수정</Link>
                </div>
                ...
                <div className="collapse" id="postService">
                    <Link to = "/professor/post" className='list-group-item py-2'>내 쪽지함</Link>
                </div>
            </div>
        </>
    );
